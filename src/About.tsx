...
const About = () => {
    return <>
        ...
        <div className="about-container">
            ...
            <p>
            Initially, every split gets the same time. Use the <i className="fa fa-plus" aria-hidden="true"></i> and <i className="fa fa-minus" aria-hidden="true"></i> buttons to adjust split times.
            </p>
            <p>
            ...
            <p>Click the <i className="fa fa-lock" aria-hidden="true"></i> to unlock a split.</p>
